...
<head>
  ...
  <script src='resources/lang/translator.js' type='text/javascript'></script>
  <script src='resources/lang/zh-CN.js' type='text/javascript'></script>
  ...
  <script type="text/javascript">
    $(function () {
      ...
      if (url && url.length > 1) {
    	...
    	url = "/restful/services/rest/api-docs";
      }
      // Pre load translate...
...
<div id='header'>
  <div class="swagger-ui-wrap">
    <a id="logo" href="http://swagger.io">开发者文档</a>
